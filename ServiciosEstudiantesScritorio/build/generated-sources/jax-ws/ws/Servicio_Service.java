 ...
 * 
 */
@WebServiceClient(name = "Servicio", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/ServiciosEstudiantes/Servicio?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIO_QNAME = new QName("http://ws/", "Servicio");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServiciosEstudiantes/Servicio?wsdl");
    ...
    public Servicio getServicioPort() {
        return super.getPort(new QName("http://ws/", "ServicioPort"), Servicio.class);
    }
    ...
    public Servicio getServicioPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "ServicioPort"), Servicio.class, features);
    }
